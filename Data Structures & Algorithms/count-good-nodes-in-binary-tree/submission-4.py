...
class Solution:
    def goodNodes(self, root: TreeNode) -> int:
        ...
        def dfs(node, maxVal):
            ...
            return res  # at this point res will contain the total count of "good" nodes in the given tree
        
        return dfs(root, root.val)  # we can have the initial maxVal as the very first root.val