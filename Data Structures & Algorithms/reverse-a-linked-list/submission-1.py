...
class Solution:
    def reverseList(self, head: Optional[ListNode]) -> Optional[ListNode]:
        ...
        while curr:  # means while curr is Not empty. We do this as we wanna get to the end of the array.
            ...
            curr = nxt  # and now we point curr to curr.next (original one) so that in the next iteration of while loop we can keep reversing. In the next iteration of this while loop, nxt node will be the curr.
