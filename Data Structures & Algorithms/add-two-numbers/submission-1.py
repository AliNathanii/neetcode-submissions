...
class Solution:
    def addTwoNumbers(self, l1: Optional[ListNode], l2: Optional[ListNode]) -> Optional[ListNode]:
        ...
        while l1 or l2 or carry:  # as long as any of the lists is not empty or carry is not 0
            ...
            val = v1 + v2 + carry  # at the first iteration carry will be empty but then after that it might possibly have a value and thats how we calculate val, this is how we consider all edge cases etc.
