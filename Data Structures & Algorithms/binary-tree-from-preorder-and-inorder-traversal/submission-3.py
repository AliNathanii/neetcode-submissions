...
# In-order: Left Sbtree -> Root -> Right Subtree, traverse in sorted order hence we use it in BST a lot
# Pre-order: Root -> Left Subtree -> Right Subtree
# Post-order: Left Subtree -> Right Subtree -> Root, when you wanna delete nodes in tree since it processes childtern before their parent root nodes
