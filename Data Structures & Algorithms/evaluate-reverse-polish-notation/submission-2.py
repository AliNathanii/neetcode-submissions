    ...
    def evalRPN(self, tokens: List[str]) -> int:
        ...
        for c in tokens:
            if c == "+":
                ...
                a = stack.pop()
                b = stack.pop()
                stack.append(b - a)  # important: order of operation is that the first token will be subtracted, divided etc.
        ...
        return stack[-1]  # this is the last number we appendede or pushed ie the final sum/product etc.