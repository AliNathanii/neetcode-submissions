...
class Solution:
    def isBalanced(self, root: Optional[TreeNode]) -> bool:
        ...
        if root:  # if the given root is not None, apply dfs on root and return:
        ...
        else:  # if the given root is empty we return True as an empty tree is considered to be balanced by default
            return True
